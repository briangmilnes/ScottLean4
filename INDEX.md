...
- [ScottDomains/ScottDomains/Dyadic.lean](ScottDomains/ScottDomains/Dyadic.lean) — §7.3's universal domain `U`, the ideal completion of the dyadic half-open intervals under superset, with `K(U)` and bounded completeness; **Theorem 27** proved from the one step left unformalized (the countable atomless Boolean algebra)
