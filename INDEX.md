...
- [ScottDomains/ScottDomains/A1R46.lean](ScottDomains/ScottDomains/A1R46.lean) — r0046's bookkeeping: `LemThirty.Lemma30`'s universal closure refuted, and the pre-r0046 statement of `Effective.StepFunctionsDecidable` kept verbatim with the kernel's check that it implies the restated one (r0046)
...
- [ScottDomains/ScottDomains/Thm18.lean](ScottDomains/ScottDomains/Thm18.lean) — the **Theorem 18 assembly** as a library theorem: `thm18_of_thm137_and_cor136` and its sharper chain form reduce Theorem 18 to Jung's **Theorem 1.37** and **Corollary 1.36** alone, and `thm18_viaProjections_of_thm137_and_cor136` states it with the paper's own conclusion via `Recovered.thm14`
...
- [ScottDomains/ScottDomains/A3Lemma30Schemes.lean](ScottDomains/ScottDomains/A3Lemma30Schemes.lean) — Lemma 30's tenth representation scheme, `(·)♮` p-representable over any carrier admitting the retraction pair (`rep_plotkin`), and the measurement that eight of Lemma 30's ten conjuncts follow from `Thm29Normal` alone, leaving `→` and `⇸` blocked by bounded completeness rather than by a missing scheme (r0046)
