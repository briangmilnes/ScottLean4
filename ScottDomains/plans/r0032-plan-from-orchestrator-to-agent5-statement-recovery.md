...
# r0032 agent5 — Recover Lemma 9 and Theorem 14 from the PDF

## Goal

Two of the paper's numbered results have never been stated in Lean, and not
...
| 2 | **Theorem 14** | "Equivalent characterizations of an (algebraic / bounded complete) domain" — the list of characterizations is garbled |

**Theorem 12 is no longer in this stream.** An earlier version of this plan
included it; r0031 recovered its `T` axioms from the PDF, so it is a proof task
now and belongs to agent3 this round. That is the outcome to aim for here: a
result leaves this stream by becoming statable.
...
going down honestly is the metric — not the count of statements going up. If both
are unrecoverable, that is a complete and successful execution of this plan.
...
Write `reports/r0032-report-from-agent5-to-orchestrator-statement-recovery.md`
